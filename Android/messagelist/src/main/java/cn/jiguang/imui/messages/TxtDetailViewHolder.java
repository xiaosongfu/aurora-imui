...
public class TxtDetailViewHolder<MESSAGE extends IMessage>
        extends BaseMessageViewHolder<MESSAGE>
        implements MsgListAdapter.DefaultMessageViewHolder {

    protected LinearLayout mLocLL;
    protected TextView mMsgTv;
    protected TextView mMsgDescriptionTv;
    ...
    public TxtDetailViewHolder(View itemView, boolean isSender) {
        super(itemView);
        ...
        mMsgDescriptionTv = (TextView) itemView.findViewById(R.id.aurora_tv_msgitem_description);
    ...
    public void onBind(final MESSAGE message) {
        ...
        // 设置副标题
        if (null == message.getTxtDescription() || TextUtils.isEmpty(message.getTxtDescription())) {
            mMsgDescriptionTv.setText("");
        } else {
            mMsgDescriptionTv.setText(message.getTxtDescription());
        }
        ...
        mMsgDescriptionTv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                if (mMsgClickListener != null) {
                    mMsgClickListener.onMessageClick(message);
    ...
    public void applyStyle(MessageListStyle style) {
        ...
        mMsgDescriptionTv.setMaxWidth((int) (style.getWindowWidth() * 0.6));
        if (mIsSender) {
